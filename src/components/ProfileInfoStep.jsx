...
export const ProfileInfoStep = ({ formValues, setFormValues, nextStep, currentStep, formErrors, setFormErrors, prevStep }) => {
    ...
    return (
        <form onSubmit={handleNext} className="mt-7">
            ...
            {url ? <img className="h-40 w-full object-cover" src={url} /> : <InputFeild type="file" required label='Profile image' name="profileImage" onChange={onChange} error={formErrors['profileImage']} />}
